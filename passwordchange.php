...
if (count($_POST) > 0) {
    ...
    if ($opass == $row["password"]) {
        mysqli_query($conn, "UPDATE users set password='" . $npass . "' WHERE username ='" . $_SESSION['username'] . "'");
    ...
    <form name="frmChange" method="post" id="adform" action="#" onSubmit="return validatePassword()">
        <div style="width:500px;">
            ...
            <table border="0" cellpadding="10" cellspacing="10" width="500" align="center" class="frmtbl">
                ...
                <tr>
                    <td width="40%" class="input-group">
                        <font style="font-family: Verdana;">Current Password</font>
                    </td>
                ...
                <tr>
                    <td class="input-group">
                        <font style="font-family: Verdana;">New Password</font>
                    </td>
                ...
                <td class="input-group">
                    <font style="font-family: Verdana;">Confirm Password</font>
                </td>
